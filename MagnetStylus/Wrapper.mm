    ...
    for (int i = 0; i < rectangles.size(); i++) {
        ...
        if (rectsMap.find(rectangles[i].area()) != rectsMap.end()) {
            ...
            if (typesForRectangles[rectangles[i].area()] == 2) {
                ...
                NSArray *colorArray = [NSArray arrayWithObjects:[UIColor redColor], [UIColor blueColor], [UIColor greenColor], [UIColor orangeColor], [UIColor yellowColor], [UIColor purpleColor], [UIColor brownColor], [UIColor blackColor], [UIColor cyanColor], [UIColor grayColor],nil];
